...
change_rights () {
        ...
        sudo chown $USER:$USER /home/$USER/log
}
make_service () {
        ascii_art
...
ExecStart=conpot --template default --temp_dir /tmp/conpot --logfile /home/$USER/log/conpot.log --config /home/$USER/conpot.cfg
ExecStop=sh -c 'mkdir -p /home/$USER/archive/ && mv /home/$USER/log/conpot.json /home/$USER/archive/conpot_\${date}.json && mv /home/$USER/log/conpot.log /home/$USER/archive/conpot_\${date}.log'
